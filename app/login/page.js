...
const Login = () => {
    ...
    return (
        <>
            <div className='text-white mx-auto text-center py-20 '>
                <h1 className='text-3xl font-bold'>Login to get your page</h1>
            </div>
            <div className="social-login">
                <div className="flex flex-col gap-2 justify-center items-center p-10">
                    ...
                    <button
                        className="flex items-center w-72 text-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
